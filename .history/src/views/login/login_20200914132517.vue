<template>
 <div class="loginbox">
    <div class="enterloginbox"><div class="dowebok" id="dowebok">
        ...
        <div class="form-container sign-in-container">
            <form action="#">
                <h1>登录</h1>
                <div class="social-container">
                    <a href="#" class="social"><QqOutlined class="icons" /></a>
                    <a href="#" class="social"><WechatOutlined class="icons" /></a>
                    <a href="#" class="social"><WeiboCircleOutlined class="icons" /></a>
                </div>
                <span>或使用您的帐号</span>
        ...
        <div class="overlay-container">
            <div class="overlay">
                <div class="overlay-panel overlay-left">
                    <h1>已有帐号？</h1>
                    <p>请使用您的帐号进行登录</p>
                    <button class="ghost" @click="login">登录</button>
                </div>
                <div class="overlay-panel overlay-right">
                    <h1>没有帐号？</h1>
                    <p>立即注册加入我们，和我们一起开始旅程吧</p>
                    <button class="ghost" @click="resgiter">注册</button>
                </div>
            </div>
        </div>
    </div></div>
...
const login = () => {
    ...
    console.log(document.getElementById('dowebok'));
}
