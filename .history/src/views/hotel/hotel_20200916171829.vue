      ...
      <div class="d-f w-1 m-b-15">
        <div class="l-box">
          <div class="d-f">
            ...
            <div class="d-f lbwords" v-for="(item,index) in scenics" :key="index">
           <div v-for="(item1,index1) in item.scenics" :key="index1"><div class="m-r-10 itembox">{{item1.name}}</div></div>
            </div>
          </div>
          <div class="d-f">
            <div class="lbposition">区域：</div>
