  ...
  <div class="content">
    ...
    <div class="cover">
      <div>
        <!-- 搜索框 -->
        <div class="cover_a">
          <div class="cover_b_active cover_b">攻略</div>
          <div class="cover_b">酒店</div>
          <div class="cover_b">机票</div>
        </div>
        <!--搜索框  -->
        <div class="cover_c">
          <a-input-search
...
import { Item } from 'ant-design-vue/types/list/list';
interface Data {
  arr:ResItem[]
  list:Item
}
