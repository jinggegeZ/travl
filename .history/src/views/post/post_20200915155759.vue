      ...
      <div class="post_right">
        ...
        <div>
          <div class="sou">
            ...
            <img class="sou_icon" src="../../../public/image/search.png" alt @click="search" />
          </div>
          <!-- 推荐 -->
          <div class="sou_a">
            推荐：
        ...
        <div v-for="(item,index) in totallist" :key="index" >
          <div class="jian" v-if="item.images.length > 2">
            <div class="jian_a sl" @click="goairticle">{{item.title}}</div>
            <div class="jian_b" @click="goairticle">{{item.summary}}</div>
            <div class="jian_c">
              <div class="jian_dd" v-for="(item1,index1) in item.images.slice(0,3)" :key="index1" @click="goairticle">
            ...
            <div class="jian_e">
              ...
              <div class="jian_g" v-if="item.like">{{item.like}} 赞</div>
              <div class="jian_g" v-if="!item.like">0 赞</div>
            </div>
          </div>
          <!-- 推荐攻略1张图片-->
          <div class="tj" v-if="item.images.length < 2">
            ...
            <div class="tj_a" v-for="(item2,index2) in item.images" :key="index2">
              <img class="tj_b hvr-grow" :src="item2" alt />
            </div>
            <!--内容-->
            <div class="tj_c">
              ...
              <div class="jian_e">
                <div class="jian_f">
                  ...
                  <span class="m-l-10" v-if="item.watch === null">0</span>
                  <span class="m-l-10" v-else>{{item.watch}}</span>
                </div>
                <div class="jian_g" v-if="item.like">{{item.like}} 赞</div>
                <div class="jian_g" v-if="!item.like">0 赞</div>
              </div>
