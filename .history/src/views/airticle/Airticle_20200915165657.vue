      ...
      <div class="article_right">
        ...
        <div class="art_list">
          ...
          <div class="art_list_c">
            <div class="art_list_d">小蛮腰广州塔，怎么玩才不遗憾？</div>
...
export default defineComponent({
  ...
  setup(props, ctx: SetupContext) {
    ...
    onMounted(() => {
      if (route.query.msg) {
        data.Tlist = JSON.parse(route.query.msg)
